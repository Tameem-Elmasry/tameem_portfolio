...
const Who = ({ classes }) => {
    ...
    return (
        <div
            className={`${classes} dark:bg-zinc-800/50 bg-gray-300 p-7 rounded-2xl md:p-12`}
        >
            <p className="text-zinc dark:text-zinc-300 mb-4 md:mb-8 reveal-up md:text-xl md:max-w-[60ch]">
                ...
                lmasry, a 16-year-old MERN Stack developer from Egypt. I started
                my coding journey at age 10 and have been passionate about web
                development ever since. I specialize in creating responsive and
                user-friendly web applications using modern technologies like
                React, Node.js, Express, and MongoDB. I'm constantly improving
                my skills, contributing to real projects, and working toward
                becoming a professional full-stack developer. I believe in
                learning by doing, and I’m always open to new challenges and
            ...
            <p className="reveal-up text-zinc dark:text-zinc-300 mt-8 mb-2 md:mb-4 md:text-xl md:max-w-[60ch]">
                Outside of coding, I enjoy solving problems, helping others
                learn, and building tech communities. I’ve led tech initiatives
                like the Computer Science Show to share knowledge and support
                learners. I believe that code can change lives, and I want to be
                part of that change.
            </p>
        </div>
    );
