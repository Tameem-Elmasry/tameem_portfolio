            ...
            <div className="flex items-center gap-4 justify-between">
                <div>
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        {tags.map((label, key) => (
                            <span
                                className="sm:h-8 h-6 sm:text-sm dark:text-zinc-400 text-gray-100 dark:bg-zinc-50/5 bg-slate-900 flex justify-center items-center px-2 sm:px-3 pt-1 sm:rounded-lg rounded-md"
                                key={key}
                            >
                                {label}
                            </span>
